...
public class Contract {
    ...
    public static abstract class habitEntry implements BaseColumns{
         ...
         * TABLE NAME
         */
        public static final String TABLE_NAME="Felipes Habit";
        /**
         * ID
         */
         ...
         */
        public static final String COLUMN_NAME="Activity Name";
        /**
         * Description of the activity that is going to be performed.
         */
        public static final String COLUMN_DES="Activity Description";
        /**
         ...
         */
        public static final String COLUMN_CONTENT_COURSE="Activity course";
        /**
         * Hour the activity will take place
         */
        public static final String COLUMN_HOUR="Activity hour";
        /**
         * How much time the activity will last
         */
        public static final String COLUMN_DURATION="Activity duration";
        /**
